...
export class Dentist extends Visit {
    constructor(values) {
        const {id, status, title, description, urgency, patientName, dateOfLastVisit, doctor} = values;
    ...
    createElement() {
        ...
        this.contentWrapperAdditionalInfo.insertAdjacentHTML("beforeend", `
        ...
        this.editButton.addEventListener("click", () => {
            ...
            new Modal(editForm.render(), editForm.getFormValues.bind(editForm), "update").render(".main__container");
        })
