  ...
  createElement() {
    ...
    this.contentWrapperAdditionalInfo.insertAdjacentHTML(
      ...
      `
                  ...
                  <div>
                     ...
                     <p>${this.bloodPressure}</p>
                  </div>
                  <div>
                     <p>Body mass index:</p>
                     <p>${this.bodyMassIndex}</p>
                  </div>
                  <div>
                     <p>Age:</p>
                     <p>${this.age}</p>
                  ...
                  <div>
                     <p>Cardiovascular disease history:</p>
                     <p>${this.cardiovascularDiseaseHistory}</p>
                  </div>
                  <div>
                     <p>Status:</p>
    ...
    this.editButton.addEventListener("click", () => {
      const infoForEdit = {
        ...
        cardiovascularDiseaseHistory: this.cardiovascularDiseaseHistory,
        age: this.age,
        id: this.id,
      };
